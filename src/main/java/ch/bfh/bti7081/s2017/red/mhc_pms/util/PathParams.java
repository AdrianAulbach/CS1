...
public class PathParams
{
	...
	/**
	 * Instantiates a new path params. Default constructor used to fill with variables.
	 */
	public PathParams()
	{
	...
	/**
	 * Instantiates a new path params. The String is parsed to an array of key/value pairs.
	 * 
	 * The Url format as follows: [http://www.myurl.com/xyz]?param1=value1&param2=value2..
	 *
	...
	public PathParams(String aUrl)
	{
		...
		for(String iParam:params)
		{
			...
			if(paramDef.length<2) log.warn("Param '"+paramDef[0]+"' was undefined and will be ignored.");
			else addParam(paramDef[0], paramDef[1]);
		}
	}
	...
	{
		if(!mParams.containsKey(aKey)) log.warn("Requested param '"+aKey+"' was not found in url definition. Definition: '"+getParamString()+"'");
		return mParams.get(aKey);
	}
	
	/**
	 * Gets the string defining all params. Format: ?param1=value1&param2=value2..
	 *
