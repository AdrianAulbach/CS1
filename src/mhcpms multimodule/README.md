...
- mhcpms-addon: addon module, custom server and client side code 
- mhcpms-ui: main application module
- mhcpms-backend: backend module, contains any server side java code and dependencies
